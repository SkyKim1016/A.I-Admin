...
public class MainService {
	...
	public ResultWithData getRecommendRecipes(RecipeSetReq req) {
		...
		MainContent intro = adminMapper.getMainIntro();
		
		return ResultWithData.succcessResult().addData("popular", detail1).addData("health", detail2).addData("taste", detail3).addData("intro", intro);
	}
