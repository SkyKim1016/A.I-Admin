...
public class UserService {
	...
	public ResultWithData login(UserServiceProviderInfoReq req) 
		...
		if (user == null || user.getId() == null || user.getId().isEmpty()) {	
			...
			userReq.setLanguageId(req.getLanguageId());
			ResultWithData result = this.getFavoriteCheckOtherList(userReq);
	...
	public ResultWithData getFavoriteCheckRecipeList(RecipeReq req) {
	...
	public ResultWithData getFavoriteCheckOtherList(UserReq req) {
		...
		List<CheckActivityVO> activityList = userAuthMapper.getCheckActivityLevel(req);
		List<CheckActivityVO> ageList = userAuthMapper.getAgeLevel(req);
